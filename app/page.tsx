  ...
  const handleCreateCourse = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setFormStep(1)
        setInputValue("")
        const title = courseForm.courseName || courseDetailsForm.displayName || ""
        const query = new URLSearchParams()
        if (title) query.set("title", title)
        query.set("view", "sections")
        router.push(`/course/${encodeURIComponent(courseId)}/edit?${query.toString()}`)
      }, 800)
    }, 7000)
  }
    ...
    <div className="h-screen overflow-y-auto bg-background">
      ...
      >
        ...
        <div className="flex flex-1 min-h-0 min-w-0">
          ...
          <div className="flex flex-1 min-h-0 min-w-0">
            <div className="flex-1 min-h-0 min-w-0 flex items-center justify-center px-4 sm:px-6 py-6 sm:py-12 w-full max-w-full sm:pl-8 sm:pr-8 md:pr-20">
