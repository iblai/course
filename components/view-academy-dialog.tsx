...
export function ViewAcademyDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px] flex flex-col p-0 gap-0 overflow-hidden bg-white min-h-[min(560px,85vh)]" maxWidth="420px" maxHeight="calc(100vh - 1rem)">
        ...
        {/* Scrollable middle: profile + details */}
        <div className="flex-1 min-h-0 overflow-y-auto">
        {/* Same profile section as Create Academy dialog */}
        ...
        {/* Same form-style layout as Create Academy dialog (read-only) */}
