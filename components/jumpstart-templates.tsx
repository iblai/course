      ...
      <div className="w-full max-w-6xl mx-auto px-2 sm:px-4 min-w-0">
        <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3">
          {templates.map((template) => (
            <div
              key={template.id}
              className="cursor-pointer hover:shadow-md transition-all duration-200 bg-gradient-to-br from-[#F5F8FF] to-[#EEF4FF] border border-[#D0E0FF] rounded-lg p-3 flex flex-col min-h-[92px] min-w-0"
