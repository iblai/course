...
export function PricingSection() {
  return (
    <section id="pricing-section" className="bg-white flex items-center justify-center py-20 px-4">
      <div className="max-w-7xl mx-auto w-full">
        {/* Pricing Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Basic Plan for Hobby */}
          <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col min-h-[420px] transition-all duration-200 ease-out hover:shadow-lg hover:-translate-y-0.5 hover:border-gray-300">
            <div className="mb-6">
          ...
          <div className="relative flex flex-col">
            ...
            <div
              className="border-2 border-[#00A3EC]/30 rounded-lg p-6 flex flex-col mt-4 min-h-[420px] transition-all duration-200 ease-out hover:shadow-lg hover:-translate-y-0.5 hover:border-[#00A3EC]/50"
              style={{
          ...
          {/* Enterprise */}
          <div className="rounded-lg p-6 flex flex-col min-h-[420px] bg-gradient-to-r from-[#00A3EC] to-[#6988FF] text-white transition-all duration-200 ease-out hover:shadow-xl hover:-translate-y-0.5">
            <div className="mb-6">
